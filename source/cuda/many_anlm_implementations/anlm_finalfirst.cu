 ...
 * anlm_final.cu
 *
 * Anlm implementation that creates double linked list like structures and
 * each kernel starts searching from current pixel, first forward and then
 * backwards.
 *
 * This is the implementation of the original concept that works even for
 * extremely big images (eg. 8Kx8K) with minimal GPU ram requirments.
 *
 * Version: 0.1
 */
